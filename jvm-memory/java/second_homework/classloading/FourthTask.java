...
public class FourthTask {
    ...
    public static void main(String[] args) {
        ...
        Class<?> dogClass;
        try {
            catClass = customClassLoader.loadClass("second_homework.classloading.beans.Cat");
            animalsList.add((Animal) catClass.getDeclaredConstructor().newInstance());
            dogClass = customClassLoader.loadClass("second_homework.classloading.beans.Dog");
